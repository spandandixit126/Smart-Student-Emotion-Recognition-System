...
def video_to_frames(video_path, frames_dir, overwrite=False, every=1, chunk_size=1000):
    ...
    frame_chunks[-1][-1] = min(frame_chunks[-1][-1],
                               total - 1)  # make sure last chunk has correct end frame, also handles case chunk_size < total
...
#     # test it
#     video_to_frames(video_path='sd.mp4', frames_dir='video_frames', overwrite=False, every=100,
#                     chunk_size=100)
